...
class Forms extends AbstractPostType
{
	 ...
	 * @var string
	 */
	public const POST_TYPE_SLUG = Config::SLUG_POST_TYPE;
	 ...
	 * @var string
	 */
	public const POST_TYPE_URL_SLUG = Config::SLUG_POST_TYPE;
	 ...
	 * @var string
	 */
	public const REST_API_ENDPOINT_SLUG = Config::SLUG_POST_TYPE;
	 ...
	 * @var string
	 */
	public const POST_CAPABILITY_TYPE = Config::CAP_FORM;
	 ...
	 * @var string
	 */
	public const URL_SLUG = Config::SLUG_POST_TYPE;
