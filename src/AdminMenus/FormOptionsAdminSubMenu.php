...
/**
 * FormOptionsAdminSubMenu class.
 */
class FormOptionsAdminSubMenu extends AbstractAdminSubMenu
{
	/**
	...
	{
		return \esc_html__('Forms Options', 'eightshift-forms');
	}
	...
	{
		return [
			'settingsFormOptionsPageTitle' => \esc_html__('All From Options', 'eightshift-forms'),
			'settingsFormOptionsSubTitle' => \esc_html__('All your forms list', 'eightshift-forms'),
			'settingsFormOptionsForms' => $this->formOptions->getFormsList(),
		];
	}
}
