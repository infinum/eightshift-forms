...
/**
 * Class that holds class for admin sub menu - Entries.
 *
...
/**
 * FormEntriesAdminSubMenu class.
 */
class FormEntriesAdminSubMenu extends AbstractAdminSubMenu
{
	/**
	 ...
	 * @var string
	 */
	public const ADMIN_MENU_CAPABILITY = 'eightshift_forms_entries';
	 ...
	 * @var string
	 */
	public const ADMIN_MENU_SLUG = 'es-entries';
	...
	{
		return \esc_html__('Entries', 'eightshift-forms');
	}
