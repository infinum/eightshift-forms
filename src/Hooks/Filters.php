...
class Filters
{
	...
	public const ALL = [
		SettingsDashboard::SETTINGS_TYPE_KEY => [
			'global' => SettingsDashboard::FILTER_SETTINGS_GLOBAL_NAME,
			'settingsSidebar' => SettingsDashboard::FILTER_SETTINGS_SIDEBAR_NAME,
		...
		SettingsCaptcha::SETTINGS_TYPE_KEY => [
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_GENERAL,
			'dashboard' => [
				'key' => SettingsCaptcha::SETTINGS_CAPTCHA_USE_KEY,
				'external' => 'https://www.google.com/recaptcha/about/',
			],
		],
		SettingsGeolocation::SETTINGS_TYPE_KEY => [
			...
			'dashboard' => [
				'key' => SettingsGeolocation::SETTINGS_GEOLOCATION_USE_KEY,
			],
		],
		SettingsMailer::SETTINGS_TYPE_KEY => [
			'global' => SettingsMailer::FILTER_SETTINGS_GLOBAL_NAME,
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_GENERAL,
			'dashboard' => [
				'key' => SettingsMailer::SETTINGS_MAILER_USE_KEY,
				'external' => '',
			],
		],
		SettingsMailchimp::SETTINGS_TYPE_KEY => [
			...
			'dashboard' => [
				'key' => SettingsMailchimp::SETTINGS_MAILCHIMP_USE_KEY,
				'external' => 'https://mailchimp.com/',
			],
		],
		SettingsGreenhouse::SETTINGS_TYPE_KEY => [
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_INTEGRATION,
			'dashboard' => [
				'key' => SettingsGreenhouse::SETTINGS_GREENHOUSE_USE_KEY,
				'external' => 'https://www.greenhouse.io/',
			],
		],
		SettingsHubspot::SETTINGS_TYPE_KEY => [
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_INTEGRATION,
			'dashboard' => [
				'key' => SettingsHubspot::SETTINGS_HUBSPOT_USE_KEY,
				'external' => 'https://www.hubspot.com/',
			],
		],
		SettingsMailerlite::SETTINGS_TYPE_KEY => [
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_INTEGRATION,
			'dashboard' => [
				'key' => SettingsMailerlite::SETTINGS_MAILERLITE_USE_KEY,
				'external' => 'https://www.mailerlite.com/',
			],
		],
		SettingsGoodbits::SETTINGS_TYPE_KEY => [
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_INTEGRATION,
			'dashboard' => [
				'key' => SettingsGoodbits::SETTINGS_GOODBITS_USE_KEY,
				'external' => 'https://goodbits.io/',
			],
		],
		SettingsClearbit::SETTINGS_TYPE_KEY => [
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_INTEGRATION,
			'dashboard' => [
				'key' => SettingsClearbit::SETTINGS_CLEARBIT_USE_KEY,
				'external' => 'https://clearbit.com/',
			],
		],
		SettingsActiveCampaign::SETTINGS_TYPE_KEY => [
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_INTEGRATION,
			'dashboard' => [
				'key' => SettingsActiveCampaign::SETTINGS_ACTIVE_CAMPAIGN_USE_KEY,
				'external' => 'https://www.activecampaign.com/',
			],
		],
		...
		SettingsFallback::SETTINGS_TYPE_KEY => [
			'global' => SettingsFallback::FILTER_SETTINGS_GLOBAL_NAME,
			'settingsSidebar' => SettingsFallback::FILTER_SETTINGS_SIDEBAR_NAME,
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_TROUBLESHOOTING,
			'dashboard' => [
				'key' => SettingsFallback::SETTINGS_FALLBACK_USE_KEY,
			],
		],
		SettingsDebug::SETTINGS_TYPE_KEY => [
			'global' => SettingsDebug::FILTER_SETTINGS_GLOBAL_NAME,
			'settingsSidebar' => SettingsDebug::FILTER_SETTINGS_SIDEBAR_NAME,
			...
			'type' => SettingsAll::SETTINGS_SIEDBAR_TYPE_TROUBLESHOOTING,
			'dashboard' => [
				'key' => SettingsDebug::SETTINGS_DEBUG_USE_KEY,
			],
		],
