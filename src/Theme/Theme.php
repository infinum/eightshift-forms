...
class Theme implements ServiceInterface
{
				...
				'checkbox' => [
					...
					'parts' => [
						'label' => [
							...
							'esf:[.es-checkbox-toggle\_\_label]:pr-50',
							...
							'esf:[.es-checkbox-toggle\_\_label]:after:top-[3px]',
							'esf:[.es-checkbox-toggle\_\_label]:after:end-[24px]',
							...
							'esf:[.es-checkbox-toggle\_\_label]:peer-checked/checkbox:after:translate-x-21',
	...
	public function getTheme(): array
	{
		return [
			...
			'select' => [
				'base' => [
					...Theme::THEME_SELECTORS['select']['base'],
				],
				'parts' => [
