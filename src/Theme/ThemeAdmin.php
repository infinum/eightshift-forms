			...
			[
				...
				'global-msg' => [
					'base' => [
						...
						'esf:data-[status="warning"]:from-yellow-500/0',
						'esf:data-[status="warning"]:to-yellow-500/30',
						'esf:data-[status="info"]:border-sky-500',
						'esf:data-[status="info"]:from-sky-500/0',
						'esf:data-[status="info"]:to-sky-500/30',
					],
				],
				'loader' => [
					'base' => [
