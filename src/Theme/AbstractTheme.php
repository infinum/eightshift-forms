...
abstract class AbstractTheme
{
	...
	public const THEME_SELECTORS = [
		'input' => [
			...
			'esf:border',
			'esf:border-gray-300',
			'esf:inset-shadow-sm esf:inset-shadow-gray-100',
			'esf:bg-white',
			'esf:p-12',
			'esf:rounded-xl',
			'esf:[.es-field\_\_content-wrap_&]:rounded-none',
			'esf:[.es-field\_\_content-wrap:first-child_>_&]:rounded-l-xl',
			'esf:[.es-field\_\_content-wrap:last-child_>_&]:rounded-r-xl',
			'esf:text-xs',
			'esf:text-black',
			'esf:h-46',
			'esf:shadow-none',
			...
			'radio' => [
				'parts' => [
					...
					'label' => [
						...
						'esf:peer-checked/radio:before:bg-mauve-600',
						'esf:peer-checked/radio:before:border-mauve-600',
						'esf:peer-focus/radio:before:outline-2',
						'esf:peer-focus/radio:before:outline-offset-2',
						'esf:peer-focus/radio:before:outline-mauve-600',
