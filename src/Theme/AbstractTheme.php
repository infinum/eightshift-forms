...
abstract class AbstractTheme
{
	...
	public const THEME_SELECTORS = [
		...
		'help' => [
			'esf:text-gray-400',
			'esf:text-xs',
			'esf:[&_a]:text-mist-600',
			'esf:[&_a]:underline',
			'esf:[&_a]:hover:text-mist-700',
		],
		'help-extended' => [
			'esf:[&_ul]:list-disc',
			'esf:[&_ul]:list-inside',
		...
		'select' => [
			'base' => [
				...
				'esf:data-[type=select-multiple]:[&_.choices\_\_inner]:[&_.choices\_\_item]:bg-mist-600',
				...
				'esf:data-[type=select-multiple]:[&_.choices\_\_inner]:[&_.choices\_\_item]:[&_.choices\_\_button]:hover:text-mist-700',
			...
			'parts' => [
				...
				'select-list-dropdown' => [
					...
					'esf:[&_.choices\_\_input]:border-mist-200',
					...
					'esf:[&_.choices\_\_item--selectable]:hover:bg-mist-600/30',
					'esf:[&_.choices\_\_item--selectable]:[&.is-highlighted]:bg-mist-600/30',
					'esf:[&_.choices\_\_item--selectable]:[&.is-selected]:bg-mist-600',
		...
		return [
			'forms' => [
				'base' => [
					...
					'esf:box-mist-200',
					'esf:[&_*]:box-mist-200',
					'esf:[&_:after]:box-mist-200',
					'esf:[&_:before]:box-mist-200',
				],
			],
			'form' => [
				'base' => [
			...
			'date' => [
				...
				'parts' => [
					'picker' => [
						...
						'esf:border-mist-200',
						'esf:text-base',
						'esf:[&_.flatpickr-day]:hover:bg-mist-600/30',
						'esf:[&_.flatpickr-day]:hover:border-mist-600/30',
						'esf:[&_.flatpickr-day]:focus:bg-mist-600/30',
						'esf:[&_.flatpickr-day]:focus:border-mist-600/30',
						'esf:[&_.selected]:bg-mist-600',
						'esf:[&_.selected]:border-mist-600',
						'esf:[&_.selected]:hover:bg-mist-600',
						'esf:[&_.selected]:hover:border-mist-600',
						'esf:[&_.selected]:focus:bg-mist-600',
						'esf:[&_.selected]:focus:border-mist-600',
						'esf:[&_.today]:border-mist-200',
						'esf:[&_.today]:hover:bg-mist-600/30',
						'esf:[&_.today]:hover:border-mist-600/30',
						'esf:[&_.today]:hover:text-black',
						'esf:[&_.today]:focus:bg-mist-600/30',
						'esf:[&_.today]:focus:border-mist-600/30',
						'esf:[&_.today]:focus:text-black',
						'esf:[&_.flatpickr-next-month:hover>svg]:fill-mist-600',
						'esf:[&_.flatpickr-prev-month:hover>svg]:fill-mist-600',
					]
				]
			],
			'textarea' => [
			...
			'radio' => [
				'parts' => [
					...
					'label' => [
						...
						'esf:peer-checked/radio:before:bg-mist-600',
						'esf:peer-checked/radio:before:border-mist-600',
						'esf:peer-focus/radio:before:outline-2',
						'esf:peer-focus/radio:before:outline-offset-2',
						'esf:peer-focus/radio:before:outline-mist-600',
			...
			'range' => [
				'base' => [
					...
					'esf:[&::-webkit-slider-runnable-track]:border-mist-200',
					...
					'esf:[&::-moz-range-track]:border-mist-200',
					...
					'esf:[&::-webkit-slider-thumb]:bg-mist-600',
					'esf:[&::-webkit-slider-thumb]:border-mist-600',
					...
					'esf:focus:[&::-moz-range-thumb]:outline-mist-600',
					'esf:focus:[&::-moz-range-thumb]:shadow-none',
					'esf:focus:[&::-moz-range-thumb]:rounded-full',

					'esf:[&::-moz-range-progress]:bg-mist-600',
			...
			'rating' => [
				...
				'parts' => [
					...
					'label' => [
						'esf:text-gray-300',
						'esf:cursor-pointer',
						'esf:[&:has(~_input:checked)]:text-mist-600',
						'esf:[input:checked_+_&]:text-mist-600',
						'esf:[input:focus-visible_+_&]:outline-2',
						'esf:[input:focus-visible_+_&]:outline-offset-2',
						'esf:[input:focus-visible_+_&]:outline-mist-600',
			...
			'progress-bar' => [
				...
				'parts' => [
					...
					'multiflow' => [
						...
						'esf:[&>div.es-form-is-filled]:bg-mist-700',
						'esf:[&>div.es-form-is-active]:block',
						'esf:[&>div.es-form-is-active]:bg-mist-600',
					],
					'multistep' => [
						'esf:flex',
						'esf:items-center',
						...
						'esf:[&>div>div]:gap-10',
						'esf:[&>div>div]:text-sm',
						'esf:[&>div.es-form-is-filled>div]:before:bg-mist-700',
						'esf:[&>div.es-form-is-active>div]:before:bg-mist-600',
					],
				],
			],
			'step' => [
				'base' => [
					...
					'esf:group-[&.es-form-is-step-preview-active]/form:border-mist-200',
