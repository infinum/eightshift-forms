		...
		return [
			'forms' => [
				'base' => [
					...
					'esf:box-border',
					'esf:[&_*]:box-border',
					'esf:[&_:after]:box-border',
					'esf:[&_:before]:box-border',
				],
			],
			'form' => [
				'base' => [
			...
			'range' => [
				'base' => [
					...
					'esf:[&::-webkit-slider-thumb]:border-accent',
			...
			'progress-bar' => [
				...
				'parts' => [
					...
					'multiflow' => [
						...
						'esf:[&>div.es-form-is-filled]:bg-accent-dark',
						'esf:[&>div.es-form-is-active]:block',
						'esf:[&>div.es-form-is-active]:bg-accent',
					],
					'multistep' => [
						'esf:flex',
						'esf:items-center',
						...
						'esf:[&>div>div]:gap-10',
						'esf:[&>div>div]:text-sm',
						'esf:[&>div.es-form-is-filled>div]:before:bg-accent-dark',
						'esf:[&>div.es-form-is-active>div]:before:bg-accent',
					],
				],
			],
			'step' => [
