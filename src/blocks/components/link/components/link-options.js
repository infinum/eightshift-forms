...
export const LinkOptions = (props) => {
  ...
  return (
    <Fragment>
        ...
        <ColorPaletteCustom
          label={
            <Fragment>
              ...
              {__('Link Color', 'eightshift-forms')}
            </Fragment>
          }
          help={__('Change Link color.', 'eightshift-forms')}
          value={styleColor}
          colors={linkColors()}
      ...
      {onChangeUrl &&
        <BaseControl label={__('Link Url', 'eightshift-forms')}>
          <URLInput
            value={url}
      ...
      {onChangeIsAnchor &&
        <ToggleControl
          label={__('Anchor', 'eightshift-forms')}
          checked={isAnchor}
