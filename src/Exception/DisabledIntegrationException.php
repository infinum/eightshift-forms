...
/**
 * DisabledIntegrationException class.
 */
final class DisabledIntegrationException extends Exception implements GeneralExceptionInterface
{
	/**
	 * Internal data.
	 *
	...
	public function __construct(
		...
		array $debug = [],
		array $data = [],
		int $code = AbstractRoute::API_RESPONSE_CODE_OK
	) {
		$this->data = $data;
		$this->debug = $debug;
