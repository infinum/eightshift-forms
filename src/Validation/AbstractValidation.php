...
abstract class AbstractValidation implements ValidatorInterface
{
	...
	{
		$denyIfFileIsNotUploaded = \apply_filters(Helper::getFilterName(['validation', 'forceMimetypeFromFs']), false); // phpcs:ignore WordPress.NamingConventions.ValidHookName.NotLowercase
