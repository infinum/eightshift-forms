			...
			$output = \array_merge(
				...
				[
					...
					[
						...
						'inputFieldHelp' => \__('This number determines the level above which a submission is <strong>not</strong> considered spam. In general normal users will always get score of 0.8-0.9. The value should be between 0.1 and 1.0 (default is 0.5).', 'eightshift-forms'),
						'inputType' => 'number',
