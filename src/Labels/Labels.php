...
class Labels
{
	...
	public const LABEL_AIRTABLE_INTEGRATION_ERROR = 'airtableIntegrationError';
	...
	public const LABEL_CLEARBIT_INTEGRATION_ERROR = 'clearbitIntegrationError';
	...
	public const LABEL_GOODBITS_INTEGRATION_ERROR = 'goodbitsIntegrationError';
	...
	public const LABEL_GREENHOUSE_INTEGRATION_ERROR = 'greenhouseIntegrationError';
	...
	public const LABEL_HUBSPOT_INTEGRATION_ERROR = 'hubspotIntegrationError';
	...
	public const LABEL_MAILCHIMP_INTEGRATION_ERROR = 'mailchimpIntegrationError';
	...
	public const LABEL_MAILERLITE_INTEGRATION_ERROR = 'mailerliteIntegrationError';
	...
	public const LABEL_MOMENTS_INTEGRATION_ERROR = 'momentsIntegrationError';
	...
	public const LABEL_NATIONBUILDER_INTEGRATION_ERROR = 'nationbuilderIntegrationError';
	...
	public const LABEL_PARDOT_INTEGRATION_ERROR = 'pardotIntegrationError';
	...
	public const LABEL_TALENTLYFT_INTEGRATION_ERROR = 'talentlyftIntegrationError';
	 ...
	 *
	 * All success keys are never used directly but rather as a part of integration type success key eg. "{$type}Success".
	 */
		...
		if (!$labels) {
			$labels = [
				...
				self::LABEL_ACTIVE_CAMPAIGN_MISSING_CONFIG => [
					...
					'description' => \__('When ActiveCampaign integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
				...
				self::LABEL_ACTIVE_CAMPAIGN_SUCCESS => [
					'type' => SettingsActiveCampaign::SETTINGS_TYPE_KEY,
					'description' => \__('When ActiveCampaign integration submits the form successfully.', 'eightshift-forms'),
				...
				self::LABEL_AIRTABLE_MISSING_CONFIG => [
					...
					'description' => \__('When Airtable integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_AIRTABLE_NOT_FOUND_ERROR => [
					'type' => SettingsAirtable::SETTINGS_TYPE_KEY,
					'description' => \__('When Airtable integrations returns a not found error.', 'eightshift-forms'),
				...
				self::LABEL_AIRTABLE_INVALID_PERMISSIONS_OR_MODEL_NOT_FOUND_ERROR => [
					'type' => SettingsAirtable::SETTINGS_TYPE_KEY,
					'description' => \__('When Airtable integrations returns a invalid permissions or model not found error.', 'eightshift-forms'),
				...
				self::LABEL_AIRTABLE_INVALID_PERMISSIONS_ERROR => [
					'type' => SettingsAirtable::SETTINGS_TYPE_KEY,
					'description' => \__('When Airtable integrations returns a invalid permissions error.', 'eightshift-forms'),
				...
				self::LABEL_AIRTABLE_INVALID_REQUEST_UNKNOWN_ERROR => [
					'type' => SettingsAirtable::SETTINGS_TYPE_KEY,
					'description' => \__('When Airtable integrations returns a invalid request unknown error.', 'eightshift-forms'),
				...
				self::LABEL_AIRTABLE_INVALID_VALUE_FOR_COLUMN_ERROR => [
					'type' => SettingsAirtable::SETTINGS_TYPE_KEY,
					'description' => \__('When Airtable integrations returns a invalid value for column error.', 'eightshift-forms'),
				...
				self::LABEL_AIRTABLE_SUCCESS => [
					'type' => SettingsAirtable::SETTINGS_TYPE_KEY,
					'description' => \__('When Airtable integration submits the form successfully.', 'eightshift-forms'),
					'output' => \__('The form was submitted successfully. Thank you!', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				...
				self::LABEL_CACHE_TYPE_NOT_FOUND => [
					...
					'description' => \__('When the requested cache type does not exist.', 'eightshift-forms'),
				...
				self::LABEL_CACHE_DELETED_SUCCESS => [
					'type' => SettingsCache::SETTINGS_TYPE_KEY,
					'description' => \__('When the cache is deleted successfully.', 'eightshift-forms'),
				...
				self::LABEL_CALCULATOR_MISSING_CONFIG => [
					...
					'description' => \__('When Calculator integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_CALCULATOR_SUCCESS => [
					'type' => SettingsCalculator::SETTINGS_TYPE_KEY,
					'description' => \__('When Calculator integrations is able to calculate the form.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_FEATURE_DISABLED => [
					...
					'description' => \__('Captcha feature is disabled.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_REQUEST_MISSING_TOKEN => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Captcha request is missing token.', 'eightshift-forms'),
					'output' => \__('Spam prevention system encountered an error. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_CAPTCHA_REQUEST_WP_ERROR => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Captcha request has encountered an WP error.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_FREE_OUTPUT_ERROR => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Captcha type free returned an error response.', 'eightshift-forms'),
					'output' => \__('Spam prevention system encountered an error. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				...
				self::LABEL_CAPTCHA_WRONG_ACTION => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Captcha action provided and action returned from the response don\'t match.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_SCORE_SPAM => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Captcha score has been detected as spam.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_SUCCESS => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Captcha request has been successful.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_DEBUG_SKIP_CHECK => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Captcha debug skip check is active.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_SKIP_CHECK => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('When the captcha check is skipped due to troubleshooting settings.', 'eightshift-forms'),
					'output' => \__('Form captcha skipped due to troubleshooting config set in settings.', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				self::LABEL_CAPTCHA_BAD_REQUEST => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('When the captcha request is invalid or malformed.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_ERROR => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('When the captcha check encounters an error.', 'eightshift-forms'),
					'output' => \__('Spam prevention system encountered an error. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				self::LABEL_CAPTCHA_FRIENDLY_OUTPUT_ERROR => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Friendly Captcha returned an error response.', 'eightshift-forms'),
					'output' => \__('Spam prevention system encountered an error. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_CAPTCHA_FRIENDLY_HTTP_ERROR => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Friendly Captcha siteverify request returned a non-success HTTP status.', 'eightshift-forms'),
					'output' => \__('Spam prevention service is currently unavailable. Please try again in a moment.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_CAPTCHA_FRIENDLY_AUTH_ERROR => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Friendly Captcha API key is missing or invalid.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_FRIENDLY_BAD_REQUEST => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Friendly Captcha rejected the request as malformed.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_FRIENDLY_INVALID_SOLUTION => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Friendly Captcha solution failed validation.', 'eightshift-forms'),
					'output' => \__('The request was marked as a potential spam request. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				self::LABEL_CAPTCHA_FRIENDLY_TIMEOUT_OR_DUPLICATE => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('Friendly Captcha solution expired or was already used.', 'eightshift-forms'),
				...
				self::LABEL_CAPTCHA_FRIENDLY_ERROR => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('When Friendly Captcha encounters an error.', 'eightshift-forms'),
					'output' => \__('Spam prevention system encountered an error. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				self::LABEL_CAPTCHA_FRIENDLY_SUCCESS => [
					'type' => SettingsCaptcha::SETTINGS_TYPE_KEY,
					'description' => \__('When the Friendly Captcha check is successful.', 'eightshift-forms'),
					'output' => \__('Success', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				...
				self::LABEL_CLEARBIT_CRON_ERROR => [
					...
					'description' => \__('When Clearbit cron job is running, it can return an error for unknown entry.', 'eightshift-forms'),
				...
				self::LABEL_CLEARBIT_AUTH_REQUIRED_ERROR => [
					'type' => SettingsClearbit::SETTINGS_TYPE_KEY,
					'description' => \__('When Clearbit integrations returns a auth required error.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				...
				self::LABEL_CORVUS_MISSING_CONFIG => [
					...
					'description' => \__('When Corvus integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				...
				self::LABEL_CORVUS_SUCCESS => [
					'type' => SettingsCorvus::SETTINGS_TYPE_KEY,
					'description' => \__('When Corvus integrations is able to send a request.', 'eightshift-forms'),
					'output' => \__('Application submitted successfully. Thank you!', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				...
				self::LABEL_CRON_RUN_SUCCESS => [
					...
					'description' => \__('When a cron job runs successfully.', 'eightshift-forms'),
				...
				self::LABEL_CRON_RUN_NOT_FOUND => [
					'type' => SettingsCronJobs::SETTINGS_TYPE_KEY,
					'description' => \__('When the requested cron job is not found.', 'eightshift-forms'),
				...
				self::LABEL_CUSTOM_NO_ACTION => [
					...
					'description' => \__('When custom action is not set.', 'eightshift-forms'),
				...
				self::LABEL_CUSTOM_SUCCESS_REDIRECT => [
					'type' => SettingsMailer::SETTINGS_TYPE_CUSTOM_KEY,
					'description' => \__('When custom action is successful and redirect is set.', 'eightshift-forms'),
				...
				self::LABEL_CUSTOM_ERROR => [
					'type' => SettingsMailer::SETTINGS_TYPE_CUSTOM_KEY,
					'description' => \__('When custom action returns an error.', 'eightshift-forms'),
				...
				self::LABEL_CUSTOM_WP_ERROR => [
					'type' => SettingsMailer::SETTINGS_TYPE_CUSTOM_KEY,
					'description' => \__('When custom action returns a WP error.', 'eightshift-forms'),
				...
				self::LABEL_ENCRYPT_FAILED => [
					...
					'description' => \__('When data encryption fails.', 'eightshift-forms'),
				...
				self::LABEL_DECRYPT_FAILED => [
					'type' => SettingsDebug::SETTINGS_TYPE_KEY,
					'description' => \__('When data decryption fails.', 'eightshift-forms'),
				...
				self::LABEL_ENCRYPT_SUCCESS => [
					'type' => SettingsDebug::SETTINGS_TYPE_KEY,
					'description' => \__('When data encryption finishes successfully.', 'eightshift-forms'),
				...
				self::LABEL_DECRYPT_SUCCESS => [
					'type' => SettingsDebug::SETTINGS_TYPE_KEY,
					'description' => \__('When data decryption finishes successfully.', 'eightshift-forms'),
				...
				self::LABEL_SUBMIT_FALLBACK_ERROR => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the form submission fails and the fallback error is used.', 'eightshift-forms'),
					'output' => \__('Something went wrong while submitting your form. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				self::LABEL_TEST_API_SUCCESS => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the API connection test is successful.', 'eightshift-forms'),
				...
				self::LABEL_TEST_API_ERROR => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the API connection test fails.', 'eightshift-forms'),
				...
				self::LABEL_INTEGRATION_ITEMS_MISSING => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the integration items are missing.', 'eightshift-forms'),
				...
				self::LABEL_INTEGRATION_ITEMS_SUCCESS => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the integration items are fetched successfully.', 'eightshift-forms'),
				...
				self::LABEL_FORM_FIELDS_MISSING => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the form has no fields to provide.', 'eightshift-forms'),
				...
				self::LABEL_FORM_FIELDS_SUCCESS => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the form fields are fetched successfully.', 'eightshift-forms'),
				...
				self::LABEL_INCREMENT_RESET_SUCCESS => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the increment counter is reset successfully.', 'eightshift-forms'),
				...
				self::LABEL_LOCATIONS_RESULT_OUTPUT_ERROR => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the result output is not used in any location.', 'eightshift-forms'),
				...
				self::LABEL_LOCATIONS_FORM_ERROR => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the form is not used in any location.', 'eightshift-forms'),
				...
				self::LABEL_LOCATIONS_SUCCESS => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the locations are fetched successfully.', 'eightshift-forms'),
				...
				self::LABEL_BULK_MISSING_ITEMS => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When no items are selected for a bulk action.', 'eightshift-forms'),
				...
				self::LABEL_GENERIC_WARNING => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('Generic warning message shown to the user.', 'eightshift-forms'),
				...
				self::LABEL_GENERIC_ERROR => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('Generic error message shown to the user.', 'eightshift-forms'),
				...
				self::LABEL_SETTINGS_SUCCESS => [
					'type' => self::TYPE_GENERIC,
					'description' => \__('When the settings are saved successfully.', 'eightshift-forms'),
				...
				self::LABEL_GEOLOCATION_FEATURE_DISABLED => [
					...
					'description' => \__('Geolocation feature is disabled.', 'eightshift-forms'),
					'output' => \__('There was an error with your form submission. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => false,
				],
				self::LABEL_GEOLOCATION_MALFORMED_DECRYPT_DATA => [
					'type' => SettingsGeolocation::SETTINGS_TYPE_KEY,
					'description' => \__('Geolocation malformed decrypt data.', 'eightshift-forms'),
					'output' => \__('There was an error with your form submission. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_GEOLOCATION_DETECTION_FAILED => [
					'type' => SettingsGeolocation::SETTINGS_TYPE_KEY,
					'description' => \__('Geolocation detection failed.', 'eightshift-forms'),
					'output' => \__('There was an error with your form submission. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_GEOLOCATION_SUCCESS => [
					'type' => SettingsGeolocation::SETTINGS_TYPE_KEY,
					'description' => \__('Geolocation request has been successful.', 'eightshift-forms'),
				...
				self::LABEL_GEOLOCATION_SKIP_CHECK => [
					'type' => SettingsGeolocation::SETTINGS_TYPE_KEY,
					'description' => \__('When the geolocation check is skipped because the feature is inactive.', 'eightshift-forms'),
				...
				self::LABEL_GEOLOCATION_MALFORMED_OR_NOT_VALID => [
					'type' => SettingsGeolocation::SETTINGS_TYPE_KEY,
					'description' => \__('When the geolocation data is malformed or not valid.', 'eightshift-forms'),
				...
				self::LABEL_GEOLOCATION_COUNTRIES_MISSING => [
					'type' => SettingsGeolocation::SETTINGS_TYPE_KEY,
					'description' => \__('When the geolocation countries are missing.', 'eightshift-forms'),
				...
				self::LABEL_GEOLOCATION_COUNTRIES_SUCCESS => [
					'type' => SettingsGeolocation::SETTINGS_TYPE_KEY,
					'description' => \__('When the geolocation countries are fetched successfully.', 'eightshift-forms'),
				...
				self::LABEL_GOODBITS_MISSING_CONFIG => [
					...
					'description' => \__('When Goodbits integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_GOODBITS_BAD_REQUEST_ERROR => [
					'type' => SettingsGoodbits::SETTINGS_TYPE_KEY,
					'description' => \__('When Goodbits integrations returns a bad request error.', 'eightshift-forms'),
					'output' => \__('Something is not right with the subscription. Please check all the fields and try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				...
				self::LABEL_GREENHOUSE_MISSING_CONFIG => [
					...
					'description' => \__('When Greenhouse integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				...
				self::LABEL_GREENHOUSE_SUCCESS => [
					'type' => SettingsGreenhouse::SETTINGS_TYPE_KEY,
					'description' => \__('When Greenhouse integration submits the form successfully.', 'eightshift-forms'),
					'output' => \__('Application submitted successfully. Thank you!', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				...
				self::LABEL_HUBSPOT_MISSING_CONFIG => [
					...
					'description' => \__('When Hubspot integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_HUBSPOT_BAD_REQUEST_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a bad request error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_REQUEST_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid request error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_MAX_NUMBER_OF_SUBMITTED_VALUES_EXCEEDED_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a max number of submitted values exceeded error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_EMAIL_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid email error.', 'eightshift-forms'),
					'output' => \__('Enter a valid email address.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_HUBSPOT_BLOCKED_EMAIL_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a blocked email error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_NUMBER_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid number error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INPUT_TOO_LARGE_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a input too large error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_FIELD_NOT_IN_FORM_DEFINITION_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a field not in form definition error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_NUMBER_OUT_OF_RANGE_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a number out of range error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_VALUE_NOT_IN_FIELD_DEFINITION_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a value not in field definition error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_METADATA_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid metadata error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_GOTOWEBINAR_WEBINAR_KEY_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid gotowebinar webinar key error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_HUTK_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid hutk error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_IP_ADDRESS_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid ip address error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_PAGE_URI_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid page uri error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_INVALID_LEGAL_OPTION_FORMAT_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a invalid legal option format error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_MISSING_PROCESSING_CONSENT_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a missing processing consent error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_MISSING_PROCESSING_CONSENT_TEXT_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a missing processing consent text error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_MISSING_COMMUNICATION_CONSENT_TEXT_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a missing communication consent text error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_MISSING_LEGITIMATE_INTEREST_TEXT_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a missing legitimate interest text error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_DUPLICATE_SUBSCRIPTION_TYPE_ID_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a duplicate subscription type id error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_FORM_HAS_RECAPTCHA_ENABLED_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a form has recaptcha enabled error.', 'eightshift-forms'),
				...
				self::LABEL_HUBSPOT_ERROR_429_ERROR => [
					'type' => SettingsHubspot::SETTINGS_TYPE_KEY,
					'description' => \__('When Hubspot integrations returns a error 429 error.', 'eightshift-forms'),
				...
				self::LABEL_JIRA_MISSING_CONFIG => [
					...
					'description' => \__('When Jira integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_JIRA_MISSING_PROJECT => [
					'type' => SettingsJira::SETTINGS_TYPE_KEY,
					'description' => \__('When Jira integrations returns a missing project error.', 'eightshift-forms'),
				...
				self::LABEL_JIRA_MISSING_ISSUE_TYPE => [
					'type' => SettingsJira::SETTINGS_TYPE_KEY,
					'description' => \__('When Jira integrations returns a missing issue type error.', 'eightshift-forms'),
				...
				self::LABEL_JIRA_MISSING_SUMMARY => [
					'type' => SettingsJira::SETTINGS_TYPE_KEY,
					'description' => \__('When Jira integrations returns a missing summary error.', 'eightshift-forms'),
				...
				self::LABEL_JIRA_MISSING_EPIC_NAME => [
					'type' => SettingsJira::SETTINGS_TYPE_KEY,
					'description' => \__('When Jira integrations returns a missing epic name error.', 'eightshift-forms'),
				...
				self::LABEL_JIRA_AUTH_REQUIRED_ERROR => [
					'type' => SettingsJira::SETTINGS_TYPE_KEY,
					'description' => \__('When Jira integrations returns a auth required error.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_JIRA_INVALID_EMAIL_ERROR => [
					'type' => SettingsJira::SETTINGS_TYPE_KEY,
					'description' => \__('When Jira integrations returns a invalid email error.', 'eightshift-forms'),
					'output' => \__('Enter a valid email address.', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => false,
				],
				...
				self::LABEL_MAILCHIMP_MISSING_CONFIG => [
					...
					'description' => \__('When Mailchimp integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				...
				self::LABEL_MAILCHIMP_SUCCESS => [
					'type' => SettingsMailchimp::SETTINGS_TYPE_KEY,
					'description' => \__('When Mailchimp integration submits the form successfully.', 'eightshift-forms'),
					'output' => \__('The newsletter subscription was successful. Thank you!', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				...
				self::LABEL_MAILER_MISSING_CONFIG => [
					...
					'description' => \__('When Mailer integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_MAILER_ERROR_EMAIL_SEND => [
					'type' => SettingsMailer::SETTINGS_TYPE_KEY,
					'description' => \__('When Mailer integrations is not able to send an email.', 'eightshift-forms'),
				...
				self::LABEL_MAILERLITE_MISSING_CONFIG => [
					...
					'description' => \__('When Mailerlite integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_MAILERLITE_BAD_REQUEST_ERROR => [
					'type' => SettingsMailerlite::SETTINGS_TYPE_KEY,
					'description' => \__('When Mailerlite integrations returns a bad request error.', 'eightshift-forms'),
					'output' => \__('Something is not right with the subscription. Please check all the fields and try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				...
				self::LABEL_MIGRATION_TYPE_NOT_FOUND => [
					...
					'description' => \__('When the migration version type key is missing or not valid.', 'eightshift-forms'),
				...
				self::LABEL_MIGRATION_SUCCESS => [
					'type' => SettingsMigration::SETTINGS_TYPE_KEY,
					'description' => \__('When the migration finishes successfully.', 'eightshift-forms'),
				...
				self::LABEL_MOMENTS_BAD_REQUEST_ERROR => [
					...
					'description' => \__('When Moments integrations returns a bad request error.', 'eightshift-forms'),
				...
				self::LABEL_MOMENTS_MISSING_CONFIG => [
					'type' => SettingsMoments::SETTINGS_TYPE_KEY,
					'description' => \__('When Moments integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				...
				self::LABEL_MOMENTS_SUCCESS => [
					'type' => SettingsMoments::SETTINGS_TYPE_KEY,
					'description' => \__('When Moments integration submits the form successfully.', 'eightshift-forms'),
					'output' => \__('The form was submitted successfully. Thank you!', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				...
				self::LABEL_NATIONBUILDER_MISSING_CONFIG => [
					...
					'description' => \__('When Nationbuilder integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_NATIONBUILDER_LIST_ERROR => [
					'type' => SettingsNationbuilder::SETTINGS_TYPE_KEY,
					'description' => \__('When Nationbuilder cron job is running, it can return an error.', 'eightshift-forms'),
					'output' => \__('There was an error with the service. Please try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				...
				self::LABEL_NATIONBUILDER_BAD_REQUEST_ERROR => [
					'type' => SettingsNationbuilder::SETTINGS_TYPE_KEY,
					'description' => \__('When Nationbuilder integrations returns a bad request error.', 'eightshift-forms'),
					'output' => \__('Something is not right with the subscription. Please check all the fields and try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_NATIONBUILDER_ERROR_SETTINGS_MISSING => [
					'type' => SettingsNationbuilder::SETTINGS_TYPE_KEY,
					'description' => \__('When Nationbuilder integrations returns a error settings missing error.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_NATIONBUILDER_SERVER_ERROR => [
					'type' => SettingsNationbuilder::SETTINGS_TYPE_KEY,
					'description' => \__('When Nationbuilder integrations returns a server error.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				...
				self::LABEL_PARDOT_MISSING_CONFIG => [
					...
					'description' => \__('When Pardot integration is not configured correctly, either globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_PARDOT_BAD_REQUEST_ERROR => [
					'type' => SettingsPardot::SETTINGS_TYPE_KEY,
					'description' => \__('When Pardot integration returns a bad request error.', 'eightshift-forms'),
					'output' => \__('Something is not right with the submission. Please check all the fields and try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_PARDOT_ERROR_SETTINGS_MISSING => [
					'type' => SettingsPardot::SETTINGS_TYPE_KEY,
					'description' => \__('When Pardot integration returns a settings missing error.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_PARDOT_SERVER_ERROR => [
					'type' => SettingsPardot::SETTINGS_TYPE_KEY,
					'description' => \__('When Pardot integration returns a server error.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				...
				self::LABEL_PAYCEK_MISSING_CONFIG => [
					...
					'description' => \__('When Paycek integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				...
				self::LABEL_PIPEDRIVE_MISSING_CONFIG => [
					...
					'description' => \__('When Pipedrive integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_PIPEDRIVE_MISSING_NAME => [
					'type' => SettingsPipedrive::SETTINGS_TYPE_KEY,
					'description' => \__('When Pipedrive integrations returns a missing name error.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_PIPEDRIVE_MISSING_ORGANIZATION => [
					'type' => SettingsPipedrive::SETTINGS_TYPE_KEY,
					'description' => \__('When Pipedrive integrations returns a missing organization error.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_PIPEDRIVE_WRONG_ORGANIZATION_ID => [
					'type' => SettingsPipedrive::SETTINGS_TYPE_KEY,
					'description' => \__('When Pipedrive integrations returns a wrong organization id error.', 'eightshift-forms'),
				...
				self::LABEL_PIPEDRIVE_WRONG_DATASET => [
					'type' => SettingsPipedrive::SETTINGS_TYPE_KEY,
					'description' => \__('When Pipedrive integrations returns a wrong dataset error.', 'eightshift-forms'),
				...
				self::LABEL_TALENTLYFT_MISSING_CONFIG => [
					...
					'description' => \__('When Talentlyft integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_TALENTLYFT_BAD_REQUEST_ERROR => [
					'type' => SettingsTalentlyft::SETTINGS_TYPE_KEY,
					'description' => \__('When Talentlyft integrations returns a bad request error.', 'eightshift-forms'),
					'output' => \__('Something is not right with the job application. Please check all the fields and try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				...
				self::LABEL_TALENTLYFT_SUCCESS => [
					'type' => SettingsTalentlyft::SETTINGS_TYPE_KEY,
					'description' => \__('When Talentlyft integration submits the form successfully.', 'eightshift-forms'),
					'output' => \__('Application submitted successfully. Thank you!', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				...
				self::LABEL_TRANSFER_EXPORT_MISSING_FORMS => [
					...
					'description' => \__('When no forms are selected for export.', 'eightshift-forms'),
				...
				self::LABEL_TRANSFER_EXPORT_MISSING_RESULT_OUTPUTS => [
					'type' => SettingsTransfer::SETTINGS_TYPE_KEY,
					'description' => \__('When no result outputs are selected for export.', 'eightshift-forms'),
				...
				self::LABEL_TRANSFER_UPLOAD_MISSING_FILE => [
					'type' => SettingsTransfer::SETTINGS_TYPE_KEY,
					'description' => \__('When no file is provided for the upload.', 'eightshift-forms'),
				...
				self::LABEL_TRANSFER_UPLOAD_ERROR => [
					'type' => SettingsTransfer::SETTINGS_TYPE_KEY,
					'description' => \__('When the uploaded transfer file is invalid.', 'eightshift-forms'),
				...
				self::LABEL_TRANSFER_UPLOAD_MISSING_TYPE => [
					'type' => SettingsTransfer::SETTINGS_TYPE_KEY,
					'description' => \__('When the transfer version type key is not provided.', 'eightshift-forms'),
				...
				self::LABEL_TRANSFER_SUCCESS => [
					'type' => SettingsTransfer::SETTINGS_TYPE_KEY,
					'description' => \__('When the transfer finishes successfully.', 'eightshift-forms'),
				...
				self::LABEL_EXPORT_MISSING_ITEMS => [
					'type' => SettingsTransfer::SETTINGS_TYPE_KEY,
					'description' => \__('When no items are selected for export.', 'eightshift-forms'),
				...
				self::LABEL_EXPORT_DATA_EMPTY => [
					'type' => SettingsTransfer::SETTINGS_TYPE_KEY,
					'description' => \__('When the data for export is empty.', 'eightshift-forms'),
				...
				self::LABEL_EXPORT_SUCCESS => [
					'type' => SettingsTransfer::SETTINGS_TYPE_KEY,
					'description' => \__('When the data export finishes successfully.', 'eightshift-forms'),
				...
				self::LABEL_PERMISSION_DENIED => [
					...
					'description' => \__('Someone tried to access the forms API without the proper permissions.', 'eightshift-forms'),
					'output' => \__('You are not permitted to perform this operation.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_VALIDATION_MISSING_MANDATORY_PARAMS => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('Someone tried to submit a form without the proper mandatory params.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_SUBMIT_LOGGED_IN => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('Someone tried to submit a form while not logged in.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_SUBMIT_ONCE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('Someone tried to submit a form more than once.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_SECURITY => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('Someone tried to submit a form with too many requests and was blocked.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_PARAMS => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('Someone tried to submit a form with missing required params.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILES => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('Someone tried to submit a form with missing required files.', 'eightshift-forms'),
				...
				self::LABEL_FILES_UPLOAD_SUCCESS => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('Someone tried to submit a form with files upload success.', 'eightshift-forms'),
				...
				self::LABEL_FILES_UPLOAD_ERROR => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('Someone tried to submit a form with files upload error.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_STEPS_CURRENT_STEP_PROBLEM => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When validation steps current step is not set.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_STEPS_FIELDS_PROBLEM => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When validation steps fields are not set.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_STEPS_NEXT_STEP_PROBLEM => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When validation steps next step is not set.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_STEPS_PARAMETERS_PROBLEM => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When validation steps parameters are not set.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_STEPS_SUCCESS => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When validation steps is successful.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_REQUIRED => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a required field is left empty.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_INVALID => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a field value is not valid.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_EMAIL => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an email field value is not valid.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_EMAIL_EXISTS => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an email already exists in the system.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_EMAIL_TLD => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an email top level domain is not valid.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_URL => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a URL field value is not valid.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_NUMBER => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a numbers-only field contains invalid characters.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_WRONG_UPLOAD_PATH => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When one or more files are uploaded using an unauthorized method.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_NOT_LOCATED => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When one or more files were not uploaded to the server.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_UPLOAD => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When there is an error with the file upload.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_MAX_AMOUNT => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When more than one file is uploaded in a single-file field.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_PHONE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a phone number field value is not valid.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_DATE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a date field value is not valid.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_DATE_TIME => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a date/time field value is not valid.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_DATE_NO_FUTURE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a date field only allows dates in the past.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_MAILCHIMP_INVALID_ZIP => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a Mailchimp ZIP code field value is not valid.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_GREENHOUSE_ACCEPT_MIME => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a Greenhouse file upload has an unsupported format.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_MOMENTS_INVALID_PHONE_LENGTH => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a Moments phone number field has an invalid length.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_MOMENTS_INVALID_SPECIAL_CHARACTERS => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a Moments field contains forbidden special characters.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_WORKABLE_MAX_LENGTH127 => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a Workable field exceeds the 127 character limit.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_WORKABLE_MAX_LENGTH255 => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a Workable field exceeds the 255 character limit.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_EXTENSION_DENIED => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded file type is not allowed.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_MIME_MISMATCH => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded file\'s contents do not match its extension.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_MIME_NOT_ALLOWED => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded file type is not permitted on this site.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_SCAN_FAILED => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded file could not be processed for security inspection.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_PDF_UNSAFE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded PDF contains active content and is rejected.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_IMAGE_UNSAFE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded image is malformed or contains unexpected content.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_OFFICE_UNSAFE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded document contains macros or embedded objects and is rejected.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_CSV_UNSAFE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded CSV or spreadsheet contains potentially malicious formula content.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_ARCHIVE_UNSAFE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded archive contains disallowed or unsafe content.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_TEXT_UNSAFE => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When an uploaded text file contains script content and is rejected.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_GLOBAL_MISSING_REQUIRED_PARAMS => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When one or more required parameters are missing from the request.', 'eightshift-forms'),
				...
				self::LABEL_VALIDATION_FILE_UPLOAD_SUCCESS => [
					'type' => SettingsValidation::SETTINGS_TYPE_KEY,
					'description' => \__('When a file is uploaded successfully.', 'eightshift-forms'),
					'output' => \__('File uploaded successfully.', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
				...
				self::LABEL_WORKABLE_MISSING_CONFIG => [
					...
					'description' => \__('When Workable integrations is not configured correctly, ether globally or per form.', 'eightshift-forms'),
					'output' => \__('This form is not configured correctly. Please get in touch with the website administrator to resolve this issue.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => true,
				],
				self::LABEL_WORKABLE_BAD_REQUEST_ERROR => [
					'type' => SettingsWorkable::SETTINGS_TYPE_KEY,
					'description' => \__('When Workable integrations returns a bad request error.', 'eightshift-forms'),
					'output' => \__('Something is not right with the job application. Please check all the fields and try again.', 'eightshift-forms'),
					'isActivityLogRecommended' => true,
					'outputLabel' => false,
				],
				self::LABEL_WORKABLE_ARCHIVED_JOB_ERROR => [
					'type' => SettingsWorkable::SETTINGS_TYPE_KEY,
					'description' => \__('When Workable integrations returns a archived job error.', 'eightshift-forms'),
				...
				self::LABEL_WORKABLE_SUCCESS => [
					'type' => SettingsWorkable::SETTINGS_TYPE_KEY,
					'description' => \__('When Workable integration submits the form successfully.', 'eightshift-forms'),
					'output' => \__('Application submitted successfully. Thank you!', 'eightshift-forms'),
					'isActivityLogRecommended' => false,
					'outputLabel' => true,
				],
