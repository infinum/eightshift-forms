	...
	public function routeCallback(WP_REST_Request $request)
	{
		...
		if (!isset($params['type'])) {
			return \rest_ensure_response([
				'code' => 400,
				'status' => 'error',
				'message' => \esc_html__('Error, no cache type key was provided.', 'eightshift-forms'),
			]);
		}
		...
		return \rest_ensure_response([
			...
			'message' => \sprintf(\esc_html__('%s cache successfully deleted!', 'eightshift-forms'), \ucfirst($type)),
		]);
	}
}
