...
export class Utils {
	...
	getComparator() {
		return {
			...
			[globalManifest.comparatorExtended.B]: (start, value, end) => parseFloat(String(start)) > parseFloat(String(value)) && parseFloat(String(start)) < parseFloat(String(end)),
			[globalManifest.comparatorExtended.BS]: (start, value, end) => parseFloat(String(start)) >= parseFloat(String(value)) && parseFloat(String(start)) <= parseFloat(String(end)),
			[globalManifest.comparatorExtended.BN]: (start, value, end) => parseFloat(String(start)) < parseFloat(String(value)) || parseFloat(String(start)) > parseFloat(String(end)),
