...
$formHideFormOnSuccess = Helpers::checkAttr('formHideFormOnSuccess', $attributes, $manifest);
...
if ($formHideFormOnSuccess) {
	$formAttrs[UtilsHelper::getStateAttribute('formHideOnSuccess')] = 'true';
}
