...
<span class="<?php echo esc_attr($tooltipClass); ?>">
	...
	?>
	<span class="<?php echo esc_attr("{$componentClass}__inner"); ?> <?php echo esc_attr($tooltipInnerPositionClass); ?> esf:bg-mist-600 esf:text-white esf:rounded esf:hidden esf:group-hover/tooltip:block esf:p-[5px_10px] esf:absolute esf:z-[999] esf:w-150 esf:text-[11px] esf:leading-snug">
