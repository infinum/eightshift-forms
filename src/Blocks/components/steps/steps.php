...
<div>
	...
	<ul class="esf-steps-list esf:flex esf:flex-col esf:gap-8 esf:m-0 esf:p-0 esf:list-none">
		<?php foreach ($stepsContent as $step) { ?>
			<li class="esf-steps-item esf:flex esf:items-baseline esf:gap-8 esf:m-0 esf:p-0 esf:text-xs esf:leading-relaxed esf:text-secondary-500 esf:[&_a]:text-accent-600 esf:[&_a]:underline esf:[&_a]:decoration-dotted">
				<span>
