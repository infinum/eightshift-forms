			...
			<?php foreach ($innerItems as $item) { ?>
				...
				<li class="esf:m-0!">
					<a
						...
						class="esf-focus-ring esf:w-120 esf:group esf:relative esf:shrink-0 esf:flex esf:items-center esf:gap-6 esf:select-none esf:transition-plus esf:text-center esf:text-xs esf:leading-[1.15] esf:text-box-trim esf:any-focus:outline-hidden esf:contrast-more:inset-ring esf:contrast-more:inset-ring-mist-0/0 esf:contrast-more:focus-visible:inset-ring---mist-esf:disabled:text-gray-400 esf:font-variation-['wdth'_102,'wght'_325,'ROND'_0,'slnt'_0,'GRAD'_0] esf:hover:font-variation-['wdth'_102,'wght'_325,'ROND'_100,'slnt'_0,'GRAD'_0] esf:data-selected:font-variation-['wdth'_102,'wght'_325,'ROND'_50,'slnt'_0,'GRAD'_50] esf:justify-center-safe esf:flex-col esf:rounded-md esf:not-has-any-icon:rounded-3xl esf:text-gray-500 esf:data-selected:text-m-m-mist-f:not-has-any-icon:selected:bg-mi-mi-mist-f:not-has-any-icon:not-selected:hover:bg-gray-50 esf:p-8"
						<?php if ($isActive) { ?>
						data-selected="true"
						<?php } ?>>
