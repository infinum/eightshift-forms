			...
			{!['number', 'range'].includes(inputType) && (
				<>
					<Spacer
						...
						text={__('Entry length', 'eightshift-forms')}
					/>
					<HStack>
						<NumberPicker
			...
			{(inputType === 'number' || inputType === 'range') && (
				<>
					<Spacer
						border
						icon={icons.range}
						text={__('Value range', 'eightshift-forms')}
					/>
					{inputType === 'range' && (
						<>
							<Toggle
							...
							>
								<HStack>
									<InputField
										label={<RichLabel label={__('Min prefix', 'eightshift-forms')} />}
									...
									/>
									<InputField
										label={<RichLabel label={__('Min suffix', 'eightshift-forms')} />}
							...
							>
								<HStack>
									<InputField
										label={<RichLabel label={__('Current prefix', 'eightshift-forms')} />}
									...
									/>
									<InputField
										label={<RichLabel label={__('Current suffix', 'eightshift-forms')} />}
							...
							>
								<HStack>
									<InputField
										label={<RichLabel label={__('Max prefix', 'eightshift-forms')} />}
									...
									/>
									<InputField
										label={<RichLabel label={__('Max suffix', 'eightshift-forms')} />}
			...
			{(inputType === 'number' || inputType === 'range') && (
				<>
					<Spacer
						border
						icon={icons.step}
						text={__('Increment step', 'eightshift-forms')}
					/>
					<NumberPicker
						value={inputStep}
