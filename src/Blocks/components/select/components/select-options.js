				...
				>
					<div>
						<div>
							...
							{selectMinCount > 0 &&
								!isOptionDisabled(getAttrKey('selectMinCount', attributes, manifest), selectDisabledOptions) && (
									<Button
						...
						<div>
							...
							{selectMaxCount > 0 &&
								!isOptionDisabled(getAttrKey('selectMaxCount', attributes, manifest), selectDisabledOptions) && (
									<Button
										label={__('Clear', 'eightshift-forms')}
										icon={icons.clear}
