				...
				<ContainerGroup>
					...
					<Container centered>
						<RichLabel
							...
							className='esf:font-bold! es:text-accent-600'
						/>
						&nbsp;
						{__('if the variable name is', 'eightshift-forms')}
						&nbsp;
						<span className='esf:font-medium es:font-mono es:text-accent-600'>{resultOutputItemName}</span>
						&nbsp;
						{__('and variable value', 'eightshift-forms')}
						&nbsp;
						<span className='esf:font-medium es:font-mono es:text-accent-600'>{outputName}</span>
					</Container>
				</ContainerGroup>
			</div>
