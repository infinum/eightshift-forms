...
export const WorkableOptions = ({ postId }) => {
	const {
		settingsPageUrl,
	...
	return (
		<PanelBody title={__('Workable', 'eightshift-forms')}>
			<BaseControl
				label={<IconLabel icon={icons.options} label={__('Settings', 'eightshift-forms')} />}
				help={__('On Workable settings page you can setup all details regarding you integration.', 'eightshift-forms')}
			>
				<Button
