...
class SettingsActiveCampaign implements SettingGlobalInterface, ServiceInterface
{
	...
	{
		$isUsed = SettingsHelper::isOptionCheckboxChecked(SettingsActiveCampaign::SETTINGS_ACTIVE_CAMPAIGN_USE_KEY, SettingsActiveCampaign::SETTINGS_ACTIVE_CAMPAIGN_USE_KEY);
		$apiKey = SettingsHelper::getSettingsDisabledOutputWithDebugFilter(Variables::getApiKeyActiveCampaign(), self::SETTINGS_ACTIVE_CAMPAIGN_API_KEY_KEY)['value'];
		$url = SettingsHelper::getSettingsDisabledOutputWithDebugFilter(Variables::getApiUrlActiveCampaign(), self::SETTINGS_ACTIVE_CAMPAIGN_API_URL_KEY)['value'];
	...
	public function getSettingsGlobalData(): array
	{
		...
		if (!SettingsHelper::isOptionCheckboxChecked(self::SETTINGS_ACTIVE_CAMPAIGN_USE_KEY, self::SETTINGS_ACTIVE_CAMPAIGN_USE_KEY)) {
		...
		$deactivateIntegration = SettingsHelper::isOptionCheckboxChecked(self::SETTINGS_ACTIVE_CAMPAIGN_SKIP_INTEGRATION_KEY, self::SETTINGS_ACTIVE_CAMPAIGN_SKIP_INTEGRATION_KEY);
					...
					[
						...
						'tabContent' => [
							[
								...
								'checkboxesName' => SettingsHelper::getOptionName(self::SETTINGS_ACTIVE_CAMPAIGN_SKIP_INTEGRATION_KEY),
								'checkboxesContent' => [
									[
										'component' => 'checkbox',
