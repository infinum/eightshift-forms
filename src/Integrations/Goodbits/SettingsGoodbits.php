...
class SettingsGoodbits implements SettingGlobalInterface, ServiceInterface
{
	...
	public function getSettingsGlobalData(): array
	{
		...
		$deactivateIntegration = $this->isCheckboxOptionChecked(self::SETTINGS_GOODBITS_SKIP_INTEGRATION_KEY, self::SETTINGS_GOODBITS_SKIP_INTEGRATION_KEY);
					...
					[
						...
						'tabContent' => [
							[
								...
								'checkboxesName' => $this->getSettingsName(self::SETTINGS_GOODBITS_SKIP_INTEGRATION_KEY),
								'checkboxesContent' => [
									[
										'component' => 'checkbox',
