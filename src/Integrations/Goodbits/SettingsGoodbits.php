...
class SettingsGoodbits implements SettingGlobalInterface, ServiceInterface
{
	...
	public function getSettingsGlobalData(): array
	{
		...
		if (!$this->isOptionCheckboxChecked(self::SETTINGS_GOODBITS_USE_KEY, self::SETTINGS_GOODBITS_USE_KEY)) {
					...
					[
						...
						'tabContent' => [
							[
								...
								'checkboxesName' => $this->getOptionName(self::SETTINGS_GOODBITS_SKIP_INTEGRATION_KEY),
								'checkboxesContent' => [
									[
										'component' => 'checkbox',
