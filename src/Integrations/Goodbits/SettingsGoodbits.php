 ...
 */
class SettingsGoodbits extends AbstractSettingsIntegrations implements SettingGlobalInterface, ServiceInterface
{
	/**
	 ...
	 * Skip integration.
	 */
	public const SETTINGS_GOODBITS_SKIP_INTEGRATION_KEY = 'goodbits-skip-integration';
	...
	public function getSettingsGlobalData(): array
	{
		...
		if (!SettingsHelpers::isOptionCheckboxChecked(self::SETTINGS_GOODBITS_USE_KEY, self::SETTINGS_GOODBITS_USE_KEY)) {
			return SettingsOutputHelpers::getNoActiveFeature();
		}

		$deactivateIntegration = SettingsHelpers::isOptionCheckboxChecked(self::SETTINGS_GOODBITS_SKIP_INTEGRATION_KEY, self::SETTINGS_GOODBITS_SKIP_INTEGRATION_KEY);
					...
					[
						...
						'tabContent' => [
							[
								...
								'checkboxesName' => SettingsHelpers::getOptionName(self::SETTINGS_GOODBITS_SKIP_INTEGRATION_KEY),
								'checkboxesContent' => [
									[
										'component' => 'checkbox',
